var assert = require('assert'),
    ...
    util = require('util'),
    bbb = new Bbb(conf.url, conf.secret);
...
var linkData = {
    ...
    linkResult = conf.url +
        ...
        // Remember to manually generate your expected SHA1 checksum to test against your program
        "&password=WWoon2G8&checksum=45bfd4a3049593fdc71df23d38fd5d357f82148b";
